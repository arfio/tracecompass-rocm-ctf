...
package org.eclipse.tracecompass.incubator.internal.rocm.ctf.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.rocm.ctf.core"; //$NON-NLS-1$
